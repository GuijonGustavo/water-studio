...
for (j in seq_along(eti_sitio)) {
  ...
  name_table_en <- paste("csv-graphs/metz1/en/",name_en,"_en.csv",sep = "")
  write.table(var_rank_info(sitio_mim, eti_sitio[j]), file = name_table_en, sep = ",", col.names = NA)
  
  #save plot
  plot_en <- paste("images/metz1/en/",name_en,"_en.png",sep = "")
  ggsave(plot_en)
...
for (k in seq_along(eti_sitio)) {
  ...
  name_table_ig <- paste("csv-graphs/metz1/ig/",name_ig,"_ig.csv",sep = "")
  write.table(var_rank_info(sitio_mim, eti_sitio[k]), file = name_table_ig, sep = ",", col.names = NA)
  
  #save plot
  plot_ig <- paste("images/metz1/ig/",name_ig,"_ig.png",sep = "")
  ggsave(plot_ig)
}
...
for (l in seq_along(eti_sitio)) {
  ...
  name_table_gr <- paste("csv-graphs/metz1/gr/",name_gr,"_gr.csv",sep = "")
  write.table(var_rank_info(sitio_mim, eti_sitio[l]), file = name_table_gr, sep = ",", col.names = NA)
  
  #save plot
  plot_gr <- paste("images/metz1/gr/",name_gr,"_gr.png",sep = "")
  ggsave(plot_gr)
}
