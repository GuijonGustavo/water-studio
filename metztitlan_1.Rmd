...
for (i in seq_along(eti_sitio)) {
  ...
  #plot in Rmd
    ...
    #try(print(var_rank_info(sitio_mim, eti_sitio[i])))
  #save table in csv
...
for (j in seq_along(eti_sitio)) {
    ...
    print(plot <- ggplot(var_rank_info(sitio_mim,  eti_sitio[j]), aes(x = reorder(var, en),y = en, fill = var))
          + geom_bar(stat = "identity") 
          + coord_flip() 
          + theme_bw() 
          + xlab("") 
  ...
  #try(print(var_rank_info(sitio_mim, eti_sitio[j])))
  
  #save table in csv
  name_table_en <- names_eti_sitio[j]
  new_name_table_en <- paste("csv-graphs/metz1/en/",name_table_en,"_en.csv",sep = "")
  write.table(var_rank_info(sitio_mim, eti_sitio[j]), file = new_name_table_en, sep = ",", col.names = NA)
...
for (k in seq_along(eti_sitio)) {
    ...
    print(plot <- ggplot(var_rank_info(sitio_mim,  eti_sitio[k]), aes(x = reorder(var, ig),y = ig, fill = var))
          + geom_bar(stat = "identity") 
          + coord_flip() 
          + theme_bw() 
          + xlab("") 
  ...
  #try(print(var_rank_info(sitio_mim, eti_sitio[k])))
  
  #save table in csv
  name_table_ig <- names_eti_sitio[k]
  new_name_table_ig <- paste("csv-graphs/metz1/ig/",name_table_ig,"_ig.csv",sep = "")
  write.table(var_rank_info(sitio_mim, eti_sitio[k]), file = new_name_table_ig, sep = ",", col.names = NA)
...
for (l in seq_along(eti_sitio)) {
    ...
    print(plot <- ggplot(var_rank_info(sitio_mim,  eti_sitio[l]), aes(x = reorder(var, gr),y = gr, fill = var))
          + geom_bar(stat = "identity") 
          + coord_flip() 
          + theme_bw() 
          + xlab("") 
  ...
  #try(print(var_rank_info(sitio_mim, eti_sitio[l])))
  
  #save table in csv
  name_table_gr <- names_eti_sitio[l]
  new_name_table_gr <- paste("csv-graphs/metz1/gr/",name_table_gr,"_gr.csv",sep = "")
  write.table(var_rank_info(sitio_mim, eti_sitio[l]), file = new_name_table_gr, sep = ",", col.names = NA)
